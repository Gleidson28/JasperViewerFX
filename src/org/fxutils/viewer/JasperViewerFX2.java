...
public class JasperViewerFX2 {
    ...
    public JasperViewerFX2(Stage owner, String title, String jasper, HashMap params, Connection con){
    ...
    public JasperViewerFX2(Stage owner, String title, String jasper, HashMap params, JRBeanCollectionDataSource source){
